...
response_ratio <- function(df, column, title, subtitle){
  ...
  data <- data.frame(logmeans, logerrors, Survey_Year)
...
response_ratio(base_data, 36, "Parastichopus californicus", " ") ## sea cucumber ##
response_ratio(base_data, 32, "Stylaster californicus", " ") ## hydrocoral ##
response_ratio(base_data, 56, "Urticina piscivora", " ") ## Fish-eating anemone ##
response_ratio(base_data, 79, "Tethya aurantia", " ") ## Puffball sponge ##
response_ratio(base_data, 95, "Mediaster aequalis", " ") ## Red sea star ##
response_ratio(base_data, 96, "Mesocentrotus franciscana", " ") ## Red sea urchin ##
response_ratio(base_data, 121, "Pycnopodia helianthoides", " ") ## Sunflower star ##
response_ratio(base_data, 173, "Stylatula elongata", " ") ## White sea pen ##

## Functional Groups ##

response_ratio(base_data, 179, "Actiniaria", " ") ## Anemones ##
response_ratio(base_data, 180, "Alcyonacea", " ") ## Soft corals ##
response_ratio(base_data, 181, "Asteroidea", " ") ## Sea stars ##
