...
ggplot(rovsppmetaS, aes(x=Year, y=shannon, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaS, aes(x=Year, y=simpson, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaS, aes(x=Year, y=eveness, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaS, aes(x=Year, y=richness, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
...
ggplot(rovsppmetaC, aes(x=Year, y=shannon, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaC, aes(x=Year, y=simpson, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaC, aes(x=Year, y=eveness, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaC, aes(x=Year, y=richness, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
...
ggplot(rovsppmetaN, aes(x=Year, y=shannon, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaN, aes(x=Year, y=simpson, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaN, aes(x=Year, y=eveness, fill=Designation))+
  geom_point(shape=21, color="black")+
  facet_wrap(~MPA_Group)+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))
  
ggplot(rovsppmetaN, aes(x=Year, y=richness, fill=Designation))+
  geom_point(shape=21, color="black")+
  geom_smooth(method='lm', se=FALSE, aes(color=Designation))+
  facet_wrap(~MPA_Group)
```
